...
export const getNormalizedData = () => {
    ...
    const normalizedFeatures = features.map(feature => {
        ...
        feature.experience.all_years.forEach(year => {
            ...
            featureYears[year.year].awareness = featureYears[year.year].used + featureYears[year.year].heard
            featureYears[year.year].awarenessRatio = featureYears[year.year].awareness / participation[year.year]
            featureYears[year.year].usageRatio = featureYears[year.year].used / featureYears[year.year].awareness
        })
